...
export function FeaturedWork() {
  ...
  return (
    <section id="work" className="py-24 md:py-32 relative bg-black/50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            ...
            <AnimatedText 
              ...
              el="h2"
              className="font-heading text-4xl md:text-6xl font-bold tracking-tighter text-white"
            />
          </div>
        ...
        {filteredProjects.length > 4 && (
          <div className="flex justify-center mt-16">
            <Link 
              href="/work"
              className="px-8 py-3 rounded-full border border-accent text-accent font-bold tracking-widest uppercase text-sm hover:bg-accent hover:text-white transition-colors duration-300 inline-block"
            >
              View More Projects
            </Link>
          </div>
